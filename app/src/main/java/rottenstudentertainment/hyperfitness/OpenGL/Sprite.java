...
public class Sprite //other drawing possibility of a square
{
    ...
    private final String vertexShaderCode =
            "uniform mat4 u_Matrix;" +
                    ...
                    "void main()"+
                    "{" +
                    "v_TextureCoordinates[0] = a_TextureCoordinates[0]/u_Sprite[2] + u_Sprite[0]/u_Sprite[2];" +
                    "v_TextureCoordinates[1] = a_TextureCoordinates[1]/u_Sprite[3] + u_Sprite[1]/u_Sprite[3];" +
     ...
     */
    public Sprite(Context context, int texture, float width, float height) {
...
//        Log.e("bild ratio test", "height: " + height + " width: " + width );
        ...
        Sprite_data = new float[4]; // shift_x, shift _y, parts_x, parts_y
        ...
        //for sprite
        mSprite = glGetUniformLocation(mProgram, "u_Sprite");
     ...
     * this shape.
     */
    public void draw(float[] mvpMatrix, float shift_x, float shift_y, float parts_x, float parts_y) {
        ...
        Sprite_data[0] = shift_x; Sprite_data[1] = shift_y; Sprite_data[2] = parts_x; Sprite_data[3] = parts_y;
        //pass the Sprite info into shader program
        glUniform4fv(mSprite, 1, Sprite_data, 0);
