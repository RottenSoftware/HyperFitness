...
//        Log.e("surfaceview:", "x:" + x); Log.e("surfaceview:", "y:" + y);
//        Log.e("surfaceview:", "x_korr:" + (x/getWidth()*2-1.0f)); Log.e("surfaceview:", "y_korr:" +  (-y/getHeight()*2+1.0f)  );

        mRenderer.set_xy(x/getWidth()*2-1.0f,-y/getHeight()*2+1.0f);
