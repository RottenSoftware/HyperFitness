...
public class Sprite_Square //other drawing possibility of a square
{
    ...
    private final String vertexShaderCode =
            "uniform mat4 u_Matrix;" +
                    ...
                    "void main()"+
                    "{" +
                   // "v_TextureCoordinates = a_TextureCoordinates / 2.0f + 0.5f;" +
                     "v_TextureCoordinates.x = a_TextureCoordinates.x / 2.0f;" +
                     "v_TextureCoordinates.y = a_TextureCoordinates.y / 3.0f;" +
...
//        -size_x + xOrigin,     -size_y + yOrigin,    0f,    1.0f,
     ...
     */
    public Sprite_Square(Context context) {
